...
Namespace UnitOperations
    ...
    <System.Serializable()> Public Class Cooler
        ...
        Public Overrides Sub Calculate(Optional ByVal args As Object = Nothing)
            ...
            Select Case Me.CalcMode
                ...
                Case CalculationMode.HeatRemoved
                    ...
                    IObj?.Paragraphs.Add("Calculation Mode: Heat Removed")
        ...
        Public Overrides Function GetReport(su As IUnitsOfMeasure, ci As Globalization.CultureInfo, numberformat As String) As String
            ...
            str.AppendLine("Cooler: " & Me.GraphicObject.Tag)
        ...
        Public Overrides Function GetStructuredReport() As List(Of Tuple(Of ReportItemType, String()))
            ...
            list.Add(New Tuple(Of ReportItemType, String())(ReportItemType.Label, New String() {"Results Report for Cooler '" & Me.GraphicObject.Tag + "'"}))
        ...
        Public Overrides Function GetPropertyDescription(p As String) As String
            ...
            ElseIf p.Equals("Heat Removed") Then
                Return "If you chose 'Heat Removed' as the calculation mode, enter the desired value. If you chose a different calculation mode, this parameter will be calculated."

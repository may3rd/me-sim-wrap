'    Peng-Robinson (1978) Property Package 
...
Namespace PropertyPackages.Auxiliary
    ...
    <System.Serializable()> Public Class PengRobinson78
        ...
        Function CalcPartialVolume(ByVal T As Double, ByVal P As Double, ByVal Vx As Double(), ByVal VKij As Double(,), ByVal VTc As Double(), ByVal VPc As Double(), ByVal Vw As Double(), ByVal VTb As Double(), ByVal TIPO As String, ByVal deltaP As Double)
            ...
            Dim pr2 As New ThermoPlugs.PR78
...
Namespace PropertyPackages.ThermoPlugs
    ...
    <System.Serializable()> Public Class PR78
        ...
        '<Cudafy.Cudafy()> Public Shared Sub pr_gpu_sum1(thread As Cudafy.GThread, alpha As Double(), ai As Double(), bi As Double(), ci As Double(), Tc As Double(), Pc As Double(), W As Double(), T As Double)

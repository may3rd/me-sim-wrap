...
The Docker image and `/health` endpoint have been smoke-tested locally on Linux arm64 and Linux amd64 emulation. Run the same checks on the target amd64 host before release.

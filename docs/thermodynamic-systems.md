...
acetone/cyclohexane Margules pair. Feed-phase fugacity coefficients agree within
`5e-11` relative; TP flash and caloric methods remain outside this first PRSV2-M gate.

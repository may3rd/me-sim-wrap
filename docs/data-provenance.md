...
| `data/correlations/seawater-v1.json` | `dwsim-seawater-data-1` | DWSIM Seawater package/model source and direct-class Water/Salt golden case | DWSIM 9.0.5.0 | Exact vapor-pressure coefficients, molecular-weight salinity conversion, 0.12 kg/kg ceiling, both executable salinity paths, phase fugacity, and all-liquid TP classification |
| `data/correlations/black-oil-v1.json` | `dwsim-black-oil-data-1` | DWSIM Black Oil package/model/flash/petroleum source plus saved pseudo-fluid inputs | DWSIM 9.0.5.0 | Source/runtime/case hashes, two explicit pseudo-fluid records, component vapor pressures and vaporized fractions, phase fugacity, and two-phase TP split parity |
| `data/correlations/ideal-aqueous-electrolyte-v1.json` | `dwsim-ideal-electrolyte-data-1` | DWSIM ideal-electrolyte package/base/flash source, electrolyte database, and saved Water/Na+/Cl- case | DWSIM 9.0.5.0 | Exact molecular weights, ion flags/charges, solvent-mass molalities, phase fugacity, and all-liquid TP classification |
| `data/interactions/pcsaft-v1.json` | `dwsim-pcsaft-data-1` | DWSIM PC-SAFT package/EOS source and both embedded parameter tables | DWSIM 9.0.5.0 | All 94 source pure records (93 unique CAS keys), all 33 binary interactions, source/runtime/case hashes, methane/ethane phase fugacity, and TP split parity |
